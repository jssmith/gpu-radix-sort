...
// offset Returns a distributed array (generated by arrayFactory) with one part per unique radix value
func localDistribWorker(inBkts []*PartRef, offset int, width int, arrayFactory func() (data.DistribArray, error)) (data.DistribArray, error) {
	var err error
